            ...
            <div class="modal-body">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <img class="image" src="<?php echo e(asset('/assets/images/logoServers.png')); ?>">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <img class="identity_image" src="<?php echo e(asset('/assets/images/logoServers.png')); ?>">
                        </div>
                    </div>
                </div>
                <div class="form-group">
...
</div><?php /**PATH /var/www/Server/Projects/Edite/Backend/resources/views/Partials/newMemberModal.blade.php ENDPATH**/ ?>