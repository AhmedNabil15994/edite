	    ...
	    <link rel="stylesheet" href="<?php echo e(asset('/assets/card/css/style.css')); ?>" />
	   	...
	   	<style type="text/css" media="screen">
	   		@font-face {
                ...
                src:url('<?php echo e(asset("/assets/card/fonts/Cairo-Regular.ttf")); ?>') format('truetype');
                font-weight: normal;
                font-style: normal;
            }
            ...
            @font-face {
                ...
                src: url('<?php echo e(asset("/assets/card/fonts/Cairo-Bold.ttf")); ?>') format('truetype');
                font-weight: normal;
                font-style: normal;
            }
            ...
            @font-face {
                ...
                src: url('<?php echo e(asset('/assets/card/fonts/Cairo-ExtraBold.ttf')); ?>') format('truetype');
                font-weight: normal;
                font-style: normal;
            }
	   	...
	   	<div class="bgCard">
			<div class="containerStyle">		
			   <div class="headCard headCard2 clearfix">
			   		<img style="float: right;" src="<?php echo e(asset('/assets/card/images/logo.png')); ?>" />
		   		...
		   		<div class="containerStyle">
			   		<div class="contentCard clearfix">
				   		<ul class="website" style="float: right;">
				   			<li style="width: 220px;"><a href="#"><img src="<?php echo e(asset('/assets/card/images/phoneIcon.png')); ?>" /> www.sasca.org.sa</a></li>
				   			<li style="width: 220px;"><a href="#"><img src="<?php echo e(asset('/assets/card/images/envelope.png')); ?>" /> info@sasca.org.sa</a></li>
				   		</ul>
