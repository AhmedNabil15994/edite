...
<div class="py-2 py-lg-6 subheader-transparent" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center">
            <!--begin::Dropdown-->
            <form action="<?php echo e(URL::current()); ?>" class="chart-form" method="get" >
                <div class='input-group' id='kt_daterangepicker_6'>
                    <span class="my-title"> <?php echo e(\Request::has('to') ? date('M d',strtotime(Request::get('to'))).' - '  : 'Today :'); ?> </span>
                    <input type="hidden" name="from">
                    <input type="hidden" name="to">
                    <input type='text' class="form-control" readonly="readonly" placeholder="Select date range" value="<?php echo e(\Request::has('from') ? date('M d',strtotime(Request::get('from')))  : date('M d')); ?> " />
...
<div class="row">
    <div class="col-lg-6 col-xxl-6">
        ...
        <input type="hidden" name="chartData1" value="<?php echo e(json_encode($data->chartData1)); ?>">
        <input type="hidden" name="chartData2" value="<?php echo e(json_encode($data->chartData2)); ?>">
            ...
            <div class="card-body p-0">
                <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                    ...
                    <div class="dropdown dropdown-inline">
                        <span class="label label-danger label-wide"><?php echo e($data->contactUsCount); ?></span>
                    </div>
                </div>
        ...
        <div class="card card-custom bg-gray-100 card-stretch gutter-b">
            ...
            <div class="card-header border-0 bg-danger py-5">
                ...
                <div class="card-toolbar">
                    <div class="dropdown dropdown-inline">
                        <span class="label label-warning label-wide"><?php echo e($data->webActionsCount); ?></span>
                    </div>
                </div>
            </div>
            <input type="hidden" id="froms" value="<?php echo e(\Request::get('from')); ?>">
            <input type="hidden" id="tos" value="<?php echo e(\Request::get('to')); ?>">
            <!--end::Header-->
            <!--begin::Body-->
                ...
                <div class="card-spacer mt-n25">
                    ...
                    <div class="row m-0">
                        <div class="col bg-light-warning px-6 rounded-xl mr-7 mb-7">
                            ...
                            <p class="myP"><?php echo e($data->addCount); ?> عملية جديدة</p>
                        </div>
                        <div class="col bg-light-primary px-6 rounded-xl mb-7">
                            ...
                            <p class="myP"><?php echo e($data->editCount); ?> عملية جديدة</p>
                        </div>
                    </div>
                    <!--end::Row-->
                    <!--begin::Row-->
                    <div class="row m-0">
                        <div class="col bg-light-danger px-6 rounded-xl mr-7">
                            ...
                            <p class="myP"><?php echo e($data->fastEditCount); ?> عملية جديدة</p>
                        </div>
                        <div class="col bg-light-success px-6 rounded-xl">
                            ...
                            <p class="myP"><?php echo e($data->deleteCount); ?> عملية جديدة</p>
                        </div>
                    </div>
                    <!--end::Row-->
                </div>
    ...
    <div class="col-lg-12">
        ...
        <div class="card card-custom card-stretch gutter-b">
            ...
            <div class="card-header align-items-center border-1">
                ...
                <div class="card-toolbar">
                    <div class="dropdown dropdown-inline">
                        <span class="label label-danger label-wide"><?php echo e($data->webActionsCount); ?></span>
                    </div>
                </div>
            </div>
            <!--end::Header-->
            ...
            <div class="card-body pt-4 tiles timlines">
                <?php $__currentLoopData = $data->webActions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <!--begin::Timeline-->
                <div class="timeline timeline-6 mt-3">
                    ...
                    <div class="timeline-item align-items-start">
                        ...
                        <div class="timeline-badge">
                            <i class="fa fa-genderless text-<?php echo e($action->label); ?> icon-xl"></i>
                        </div>
                        <!--end::Badge-->
                        <!--begin::Text-->
...
<script src="<?php echo e(asset('/assets/components/dashboard.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('Layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/Server/Projects/Edite/Backend/app/Modules/Dashboard/Views/dashboard.blade.php ENDPATH**/ ?>