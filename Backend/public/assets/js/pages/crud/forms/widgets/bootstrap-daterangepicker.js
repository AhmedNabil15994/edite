...
var KTBootstrapDaterangepicker = function () {
    ...
    var demos = function () {
        ...
        $('#kt_daterangepicker_6').daterangepicker({
            ...
            $('span.my-title').empty();
            $('#kt_daterangepicker_6 .form-control').css('width','100px');
            $('#kt_daterangepicker_6 .form-control').css('marginRight','10px');
            $('#kt_daterangepicker_6 .form-control').val( 
                monthNames[start.format('M')-1] + ' ' + start.format('D') + ' - ' + 
                monthNames[end.format('M')-1] + ' '+ end.format('D')
            );
        });
    }
