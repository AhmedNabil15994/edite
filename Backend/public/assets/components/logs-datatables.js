		...
		var DataTable = table.DataTable({
			...
			ajax: {
				...
				data:function(dtParms){
			       	dtParms.from1 = $('#kt_datetimepicker_7_1').val();
			        dtParms.to1 = $('#kt_datetimepicker_7_2').val();
			        dtParms.from2 = $('#kt_datetimepicker_7_3').val();
			        dtParms.to2 = $('#kt_datetimepicker_7_4').val();
			        dtParms.columnsDef= [
						'id', 'username','from_date','to_date','diff'];
			        return dtParms
			    }
			},
			columns: [
				{data: 'id'},
				{data: 'username'},
				{data: 'from_date', type: 'date'},
				{data: 'to_date', type: 'date'},
				{data: 'diff'},
				...
				},
				{
					...
					render: function(data, type, full, meta) {
						return '<a target="_BLANK" href="#">'+
									'<div style="width:100%;" class="btn btn-warning btn-shadow-hover font-weight-bold mr-2" data-id="'+full.id+'">'+data+'</div>'+
								'</a>';
					},
				},
				{
