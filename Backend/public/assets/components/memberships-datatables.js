		...
		var DataTable = table.DataTable({
			...
			ajax: {
				...
				data:function(dtParms){
			       	dtParms.price = $('input[name="price"]').val();
			       	dtParms.year_price = $('input[name="year_price"]').val();
			        dtParms.columnsDef= [
						'id' ,'title','price','discount_price','conditionsText','featruesText'];
			        return dtParms
			    }
			},
			columns: [
			...
			columnDefs: [
				...
				},
				{
					...
					className: 'edits',
					render: function(data, type, full, meta) {
						return '<a class="editable" data-col="price" data-id="'+full.id+'">'+data+'</a>';
					},
				},
				{
					targets: 3,
					...
					className: 'edits',
					render: function(data, type, full, meta) {
						return '<a class="editable" data-col="discount_price" data-id="'+full.id+'">'+data+'</a>';
					},
				},
				{
					targets: 4,
				...
				},
				{
					...
					render: function(data, type, full, meta) {
						...
						if($('input[name="data-area"]').val() == 1){
							editButton = '<a href="/memberships/edit/'+data+'" class="dropdown-item">'+
