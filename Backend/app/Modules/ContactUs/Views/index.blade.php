...
<div class="card card-custom">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            @if(\Helper::checkRules('edit-contactUs'))
    ...
    <div class="card-body">
                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="{{ URL::current() }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <input type="text" class="form-control m-input" data-col-index="1" name="name" value="{{ Request::get('name') }}" data-col-index="1">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>البريد الالكتروني:</label>
                                    <input type="email" class="form-control m-input" data-col-index="2" name="email" value="{{ Request::get('email') }}" data-col-index="1">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>الرد:</label>
                                    <input type="text" class="form-control m-input" data-col-index="5" name="reply" value="{{ Request::get('reply') }}" data-col-index="1">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-9 col-sm-12">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control datetimepicker-input" id="kt_datetimepicker_7_1" placeholder="من"  name="from" value="{{ Request::get('from') }}" data-col-index="6" data-toggle="datetimepicker" data-target="#kt_datetimepicker_7_1" />
                                        </div>
                                        <div class="col">
                                            <input type="text" class="form-control datetimepicker-input" id="kt_datetimepicker_7_2" placeholder="الي"  name="to" value="{{ Request::get('to') }}" data-col-index="6" data-toggle="datetimepicker" data-target="#kt_datetimepicker_7_2" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="{{ URL::to('/contactUs') }}" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
                                        <span>
        ...
        <input type="hidden" name="data-area" value="{{ \Helper::checkRules('edit-contactUs') }}">
        <input type="hidden" name="data-cols" value="{{ \Helper::checkRules('delete-contactUs') }}">
        <!--begin: Datatable-->
