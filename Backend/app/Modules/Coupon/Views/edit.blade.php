...
@section('title','كوبونات الخصم - تعديل')
    ...
    <div class="card-body">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="AddTabs" role="tabpanel">
                <form class="forms m-form m-form--group-seperator-dashed" method="POST" action="{{ URL::to('/coupons/update/'.$data->data->id) }}">  
                    @csrf
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <input class="form-control" type="text" name="code" value="{{ $data->data->code }}" maxlength="" placeholder="">
                    ...
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <select name="discount_type" class="form-control">
                                <option value="1" {{ $data->data->discount_type == 1 ? 'selected' : '' }}>قيمة محددة</option>
                                <option value="2" {{ $data->data->discount_type == 2 ? 'selected' : '' }}>نسبة مئوية</option>
                            </select>
                        </div>
                    </div>   
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <input class="form-control mb-5" type="text" name="discount_value" value="{{ $data->data->discount_value }}" maxlength="" placeholder="">
                        </div>
                    </div>     
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                    ...
                    <div class="form-group m-form__group row" style="padding-right: 0;padding-left: 0;padding-bottom: 10px;">
                        <div class="col-lg-12">
                            ...
                            <input class="form-control mb-5" data-toggle="{{ $data->data->valid_type == 2 ? 'datetimepicker' : '' }}" id="{{ $data->data->valid_type == 2 ? 'kt_datetimepicker_7_1' : '' }}" data-target="#kt_datetimepicker_7_1" type="text" name="valid_value" value="{{  $data->data->valid_value }}" maxlength="" placeholder="">
                        </div>
                    </div>  
                </form>
            </div>
