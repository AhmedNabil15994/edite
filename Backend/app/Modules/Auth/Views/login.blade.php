...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8" />
    <title>{{ \App\Models\Variable::getVar('العنوان عربي') }} | تسجيل الدخول</title>
  ...
  <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div class="d-flex flex-column flex-root">
      ...
      <div class="login login-3 login-signin-on d-flex flex-row-fluid" id="kt_login">
        <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url({{ asset('/assets/images/bg-3.jpg') }});">
          <div class="login-form text-center text-updated p-7 position-relative overflow-hidden">
            <!--begin::Login Header-->
            <div class="d-flex flex-center mb-15">
              <a href="#">
                <img src="{{ asset('/assets/images/favicon.ico') }}" class="max-h-100px" alt="" />
              </a>
            </div>
            <!--end::Login Header-->
            ...
            <div class="login-signin animate__animated">
              ...
              <form class="form" id="kt_login_signin_form" action="{{ URL::to('/login') }}" method="post">
                @csrf
              ...
              <div class="mt-10">
                ...
                {{-- <a href="javascript:;" id="kt_login_signup" class="text-updated font-weight-bold">Sign Up</a> --}}
              </div>
            </div>
