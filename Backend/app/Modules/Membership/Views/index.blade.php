...
<div class="card card-custom">
    ...
    <div class="card-body">
                        ...
                        <form class="m-form m-form--fit m--margin-bottom-20" method="get" action="{{ URL::current() }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <input type="text" class="form-control m-input" data-col-index="1" name="title" value="{{ Request::get('title') }}">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>السعر:</label>
                                    <input type="text" class="form-control m-input" data-col-index="2" name="price" value="{{ Request::get('price') }}">
                                    <br>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <label>السعر بعد الخصم:</label>
                                    <input type="text" class="form-control m-input" data-col-index="3" name="discount_price" value="{{ Request::get('discount_price') }}">
                                    <br>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    &nbsp;&nbsp;
                                    <a href="{{ URL::to('/memberships') }}" class="btn btn-secondary m-btn m-btn--icon" id="m_reset">
                                        <span>
        ...
        <input type="hidden" name="data-area" value="{{ \Helper::checkRules('edit-membership') }}">
        <input type="hidden" name="data-cols" value="{{ \Helper::checkRules('delete-membership') }}">
        <!--begin: Datatable-->
...
{{-- Scripts Section --}}
@section('scripts')
<script src="{{ asset('/assets/components/memberships-datatables.js')}}"></script>           
